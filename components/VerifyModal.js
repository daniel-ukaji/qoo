  ...
  return (
    <div className='relative p-6 bg-white rounded-lg'>
        ...
        <div class="flex flex-col items-center justify-center h-screen font-sora">
            ...
            <p className='text-sm text-[#667085]'>You need to complete your Profile to Continue</p>
            <button onClick={() => router.push('/AccountSettings') } className="px-40 py-4 mt-6 text-xs font-medium text-center text-white rounded-xl bg-primary w-fit">
          Continue
        </button>        
        </div>
        </section>
