...
const PageTestFour = ({ prevStep }) => {
    ...
    const handleNextClick = () => {
        if (!bedroomsSelection || !bedsSelection || !bathroomsSelection) {
    ...
    <div className='bg-white font-sora'>
        <div className="pl-10 p-6 h-screen flex flex-col justify-between max-w-[40rem] mx-auto">
            ...
            <button
              ...
              <button
                className={`py-3 px-6 mr-2 mb-2 text-sm font-medium text-white focus:outline-none bg-[#DB5461] rounded-lg border border-gray-200 ${!bedroomsSelection || !bedsSelection || !bathroomsSelection ? "bg-gray-300 pointer-events-none" : ""}`}
                disabled={!bedroomsSelection || !bedsSelection || !bathroomsSelection}
