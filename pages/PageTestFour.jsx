...
const PageTestFour = () => {
    ...
    const bedroomsSelection = useSelector((state) => state.bedroomsSelection);
    const bedsSelection = useSelector((state) => state.bedsSelection);
    const bathroomsSelection = useSelector((state) => state.bathroomsSelection);
