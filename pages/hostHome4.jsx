      ...
      <div className="p-16">
        ...
        <div className="space-y-5">
          <div className="flex space-x-6 pt-14">
            <div className="pt-10">
              <button className="py-3 px-6 mr-2 mb-2 text-sm font-medium text-black focus:outline-none bg-[#EAECF0] rounded-lg border border-gray-200">
                Back
              </button>
            </div>
            <div className="pt-10">
      ...
      <div className="relative">
        ...
        <section className="absolute p-16 ml-7">
          ...
          <div className="space-y-7">
            ...
            <h1 className="pt-3 text-4xl font-bold text-white">
              How many
              <br /> bathrooms &<br /> bedroom does your
              <br /> apartment have?
            </h1>
          </div>
        </section>
